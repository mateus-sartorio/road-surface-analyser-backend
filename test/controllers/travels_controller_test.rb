...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference("Travel.count") do
      post travels_url, params: { travel: { timestamp_begin: @travel.timestamp_begin, timestamp_end: @travel.timestamp_end } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { timestamp_begin: @travel.timestamp_begin, timestamp_end: @travel.timestamp_end } }
