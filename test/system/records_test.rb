...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "should create record" do
    ...
    fill_in "Timestamp begin", with: @record.timestamp_begin
    fill_in "Timestamp end", with: @record.timestamp_end
  ...
  test "should update Record" do
    ...
    fill_in "Timestamp begin", with: @record.timestamp_begin.to_s
    fill_in "Timestamp end", with: @record.timestamp_end.to_s
