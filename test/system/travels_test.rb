...
class TravelsTest < ApplicationSystemTestCase
  ...
  test "should create travel" do
    ...
    fill_in "Timestamp begin", with: @travel.timestamp_begin
    fill_in "Timestamp end", with: @travel.timestamp_end
  ...
  test "should update Travel" do
    ...
    fill_in "Timestamp begin", with: @travel.timestamp_begin.to_s
    fill_in "Timestamp end", with: @travel.timestamp_end.to_s
